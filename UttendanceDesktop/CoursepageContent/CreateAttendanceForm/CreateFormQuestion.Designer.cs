namespace UttendanceDesktop.CoursepageContent
{
    partial class CreateFormQuestion
    {
        ...
        private void InitializeComponent()
        {
            ...
            correctDBtn = new RadioButton();
            choiceDTextbox = new TextBox();
            choiceDLabel = new Label();
            correctCBtn = new RadioButton();
            choiceCTextbox = new TextBox();
            choiceCLabel = new Label();
            correctBBtn = new RadioButton();
            choiceBTextbox = new TextBox();
            choiceBLabel = new Label();
            correctABtn = new RadioButton();
            choiceATextbox = new TextBox();
            label1 = new Label();
            choiceALabel = new Label();
            correctLabel = new Label();
            answerChoicesLabel = new Label();
            problemStmtTextbox = new TextBox();
            asteriskLabel = new Label();
            problemStmtLabel = new Label();
            createQuestionPanel.SuspendLayout();
            SuspendLayout();
            // 
            // createQuestionPanel
            // 
            createQuestionPanel.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
            createQuestionPanel.BackColor = Color.FromArgb(166, 176, 230);
            createQuestionPanel.Controls.Add(createBtn);
            createQuestionPanel.Controls.Add(cancelBtn);
            createQuestionPanel.Controls.Add(correctDBtn);
            createQuestionPanel.Controls.Add(choiceDTextbox);
            createQuestionPanel.Controls.Add(choiceDLabel);
            createQuestionPanel.Controls.Add(correctCBtn);
            createQuestionPanel.Controls.Add(choiceCTextbox);
            createQuestionPanel.Controls.Add(choiceCLabel);
            createQuestionPanel.Controls.Add(correctBBtn);
            createQuestionPanel.Controls.Add(choiceBTextbox);
            createQuestionPanel.Controls.Add(choiceBLabel);
            createQuestionPanel.Controls.Add(correctABtn);
            createQuestionPanel.Controls.Add(choiceATextbox);
            createQuestionPanel.Controls.Add(label1);
            createQuestionPanel.Controls.Add(choiceALabel);
            createQuestionPanel.Controls.Add(correctLabel);
            createQuestionPanel.Controls.Add(answerChoicesLabel);
            createQuestionPanel.Controls.Add(problemStmtTextbox);
            ...
            // createBtn
            // 
            createBtn.BackColor = Color.FromArgb(233, 117, 2);
            ...
            Text = "Add Question";
            createQuestionPanel.ResumeLayout(false);
            createQuestionPanel.PerformLayout();
            ResumeLayout(false);
        }
        ...
        private TextBox problemStmtTextbox;
        private Label label1;
        private Label answerChoicesLabel;
        private Label correctLabel;
        private TextBox choiceATextbox;
        private Label choiceALabel;
        private RadioButton correctABtn;
        private RadioButton correctDBtn;
        private TextBox choiceDTextbox;
        private Label choiceDLabel;
        private RadioButton correctCBtn;
        private TextBox choiceCTextbox;
        private Label choiceCLabel;
        private RadioButton correctBBtn;
        private TextBox choiceBTextbox;
